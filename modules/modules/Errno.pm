...
"x86_64-linux-thread-multi-3.0.80-0.5-default" or
	die "Errno architecture (x86_64-linux-thread-multi-3.0.80-0.5-default) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
